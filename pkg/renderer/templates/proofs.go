...
// ProofsGo is the renererprocess/proofs/proofs.go file.
const ProofsGo = `package proofs

var (
	homeNames = {{.HomeButtonNames}}

	buttonNamePanelNames = {{.ButtonNamePanelNames}}

	tabNamePanelNames = {{.TabNamePanelNames}}

	panelNameButtonNames = {{.PanelNameButtonNames}}

	panelNameTabNames = {{.PanelNameTabNames}}
)
