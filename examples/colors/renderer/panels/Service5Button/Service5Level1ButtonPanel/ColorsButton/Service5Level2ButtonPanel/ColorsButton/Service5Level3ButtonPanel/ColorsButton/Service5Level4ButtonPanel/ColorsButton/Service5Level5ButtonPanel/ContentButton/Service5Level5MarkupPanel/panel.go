...
// showService5Level5MarkupPanel shows the panel you named Service5Level5MarkupPanel while hiding any other panels in it's group.
...
*/
func (panel *Panel) showService5Level5MarkupPanel(force bool) {
	panel.tools.ShowPanelInButtonGroup(panel.service5Level5MarkupPanel, force)
}
