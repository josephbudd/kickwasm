...
func (panelGroup *PanelGroup) defineMembers() (err error) {
	...
	if panelGroup.service5Level2MarkupPanel = notJS.GetElementByID("tabsMasterView-home-pad-Service5Button-Service5Level1ButtonPanel-ColorsButton-Service5Level2ButtonPanel-ContentButton-Service5Level2MarkupPanel"); panelGroup.service5Level2MarkupPanel == null {
		err = errors.New("unable to find #tabsMasterView-home-pad-Service5Button-Service5Level1ButtonPanel-ColorsButton-Service5Level2ButtonPanel-ContentButton-Service5Level2MarkupPanel")
		return
	}
...
*/
func (panelGroup *PanelGroup) showService5Level2MarkupPanel(force bool) {
	panelGroup.tools.ShowPanelInButtonGroup(panelGroup.service5Level2MarkupPanel, force)
}
