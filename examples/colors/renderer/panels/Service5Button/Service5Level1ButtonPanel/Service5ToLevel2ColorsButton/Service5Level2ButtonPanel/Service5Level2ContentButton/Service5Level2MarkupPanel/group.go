...
func (group *panelGroup) defineMembers() (err error) {
	...
	if group.service5Level2MarkupPanel = notJS.GetElementByID("tabsMasterView-home-pad-Service5Button-Service5Level1ButtonPanel-Service5ToLevel2ColorsButton-Service5Level2ButtonPanel-Service5Level2ContentButton-Service5Level2MarkupPanel"); group.service5Level2MarkupPanel == null {
		err = errors.New("unable to find #tabsMasterView-home-pad-Service5Button-Service5Level1ButtonPanel-Service5ToLevel2ColorsButton-Service5Level2ButtonPanel-Service5Level2ContentButton-Service5Level2MarkupPanel")
		return
	}
...
// This panel's id is tabsMasterView-home-pad-Service5Button-Service5Level1ButtonPanel-Service5ToLevel2ColorsButton-Service5Level2ButtonPanel-Service5Level2ContentButton-Service5Level2MarkupPanel.
...
*/
func (group *panelGroup) showService5Level2MarkupPanel(force bool) {
	tools.ShowPanelInButtonGroup(group.service5Level2MarkupPanel, force)
}
