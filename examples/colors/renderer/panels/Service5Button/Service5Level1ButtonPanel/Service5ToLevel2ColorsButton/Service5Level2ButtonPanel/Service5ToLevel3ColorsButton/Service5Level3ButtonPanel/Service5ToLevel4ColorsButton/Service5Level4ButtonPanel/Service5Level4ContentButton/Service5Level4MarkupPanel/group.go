...
func (group *panelGroup) defineMembers() (err error) {
	...
	if group.service5Level4MarkupPanel = notJS.GetElementByID("tabsMasterView-home-pad-Service5Button-Service5Level1ButtonPanel-Service5ToLevel2ColorsButton-Service5Level2ButtonPanel-Service5ToLevel3ColorsButton-Service5Level3ButtonPanel-Service5ToLevel4ColorsButton-Service5Level4ButtonPanel-Service5Level4ContentButton-Service5Level4MarkupPanel"); group.service5Level4MarkupPanel == null {
...
*/
func (group *panelGroup) showService5Level4MarkupPanel(force bool) {
	tools.ShowPanelInButtonGroup(group.service5Level4MarkupPanel, force)
}
