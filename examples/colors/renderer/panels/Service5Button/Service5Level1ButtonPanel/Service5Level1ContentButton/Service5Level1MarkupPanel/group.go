...
func (group *panelGroup) defineMembers() (err error) {
	...
	if group.service5Level1MarkupPanel = notJS.GetElementByID("tabsMasterView-home-pad-Service5Button-Service5Level1ButtonPanel-Service5Level1ContentButton-Service5Level1MarkupPanel"); group.service5Level1MarkupPanel == null {
		err = errors.New("unable to find #tabsMasterView-home-pad-Service5Button-Service5Level1ButtonPanel-Service5Level1ContentButton-Service5Level1MarkupPanel")
		return
	}
...
// This panel's id is tabsMasterView-home-pad-Service5Button-Service5Level1ButtonPanel-Service5Level1ContentButton-Service5Level1MarkupPanel.
...
*/
func (group *panelGroup) showService5Level1MarkupPanel(force bool) {
	tools.ShowPanelInButtonGroup(group.service5Level1MarkupPanel, force)
}
