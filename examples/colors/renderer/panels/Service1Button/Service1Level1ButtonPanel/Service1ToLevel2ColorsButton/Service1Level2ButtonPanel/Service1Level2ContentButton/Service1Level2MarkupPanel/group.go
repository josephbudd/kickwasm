...
func (group *panelGroup) defineMembers() (err error) {
	...
	if group.service1Level2MarkupPanel = notJS.GetElementByID("tabsMasterView-home-pad-Service1Button-Service1Level1ButtonPanel-Service1ToLevel2ColorsButton-Service1Level2ButtonPanel-Service1Level2ContentButton-Service1Level2MarkupPanel"); group.service1Level2MarkupPanel == null {
		err = errors.New("unable to find #tabsMasterView-home-pad-Service1Button-Service1Level1ButtonPanel-Service1ToLevel2ColorsButton-Service1Level2ButtonPanel-Service1Level2ContentButton-Service1Level2MarkupPanel")
		return
	}
...
// This panel's id is tabsMasterView-home-pad-Service1Button-Service1Level1ButtonPanel-Service1ToLevel2ColorsButton-Service1Level2ButtonPanel-Service1Level2ContentButton-Service1Level2MarkupPanel.
...
*/
func (group *panelGroup) showService1Level2MarkupPanel(force bool) {
	tools.ShowPanelInButtonGroup(group.service1Level2MarkupPanel, force)
}
