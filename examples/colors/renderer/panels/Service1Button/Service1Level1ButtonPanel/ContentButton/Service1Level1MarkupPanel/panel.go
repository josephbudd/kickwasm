...
/*
	...
	Panel name: Service1Level1MarkupPanel
	Panel id:   tabsMasterView-home-pad-Service1Button-Service1Level1ButtonPanel-ContentButton-Service1Level1MarkupPanel
...
func NewPanel(quitCh chan struct{}, tools *viewtools.Tools, notjs *kicknotjs.NotJS, connection map[types.CallID]caller.Renderer) *Panel {
	...
	panel.service1Level1MarkupPanel = notjs.GetElementByID("tabsMasterView-home-pad-Service1Button-Service1Level1ButtonPanel-ContentButton-Service1Level1MarkupPanel")
...
// showService1Level1MarkupPanel shows the panel you named Service1Level1MarkupPanel while hiding any other panels in it's group.
...
//          this panel #tabsMasterView-home-pad-Service1Button-Service1Level1ButtonPanel-ContentButton-Service1Level1MarkupPanel, which you named Service1Level1MarkupPanel, becomes visible.
/* Your note for this panel is:
This is the only content.
Brought to you in the first service color.

*/
func (panel *Panel) showService1Level1MarkupPanel(force bool) {
	panel.tools.ShowPanelInButtonGroup(panel.service1Level1MarkupPanel, force)
}
