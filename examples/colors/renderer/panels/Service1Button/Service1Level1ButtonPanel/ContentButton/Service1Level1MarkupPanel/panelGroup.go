...
func (panelGroup *PanelGroup) defineMembers() (err error) {
	...
	if panelGroup.service1Level1MarkupPanel = notJS.GetElementByID("tabsMasterView-home-pad-Service1Button-Service1Level1ButtonPanel-ContentButton-Service1Level1MarkupPanel"); panelGroup.service1Level1MarkupPanel == null {
		err = errors.New("unable to find #tabsMasterView-home-pad-Service1Button-Service1Level1ButtonPanel-ContentButton-Service1Level1MarkupPanel")
		return
	}
...
*/
func (panelGroup *PanelGroup) showService1Level1MarkupPanel(force bool) {
	panelGroup.tools.ShowPanelInButtonGroup(panelGroup.service1Level1MarkupPanel, force)
}
