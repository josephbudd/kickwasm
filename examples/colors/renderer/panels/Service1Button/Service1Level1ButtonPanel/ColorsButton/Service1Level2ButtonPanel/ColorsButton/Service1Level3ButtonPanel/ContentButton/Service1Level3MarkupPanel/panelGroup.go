...
func (panelGroup *PanelGroup) defineMembers() (err error) {
	...
	if panelGroup.service1Level3MarkupPanel = notJS.GetElementByID("tabsMasterView-home-pad-Service1Button-Service1Level1ButtonPanel-ColorsButton-Service1Level2ButtonPanel-ColorsButton-Service1Level3ButtonPanel-ContentButton-Service1Level3MarkupPanel"); panelGroup.service1Level3MarkupPanel == null {
		err = errors.New("unable to find #tabsMasterView-home-pad-Service1Button-Service1Level1ButtonPanel-ColorsButton-Service1Level2ButtonPanel-ColorsButton-Service1Level3ButtonPanel-ContentButton-Service1Level3MarkupPanel")
		return
	}
...
*/
func (panelGroup *PanelGroup) showService1Level3MarkupPanel(force bool) {
	panelGroup.tools.ShowPanelInButtonGroup(panelGroup.service1Level3MarkupPanel, force)
}
