...
func (group *panelGroup) defineMembers() (err error) {
	...
	if group.service2Level2MarkupPanel = notJS.GetElementByID("tabsMasterView-home-pad-Service2Button-Service2Level1ButtonPanel-Service2ToLevel2ColorsButton-Service2Level2ButtonPanel-Service2Level2ContentButton-Service2Level2MarkupPanel"); group.service2Level2MarkupPanel == null {
		err = errors.New("unable to find #tabsMasterView-home-pad-Service2Button-Service2Level1ButtonPanel-Service2ToLevel2ColorsButton-Service2Level2ButtonPanel-Service2Level2ContentButton-Service2Level2MarkupPanel")
		return
	}
...
// This panel's id is tabsMasterView-home-pad-Service2Button-Service2Level1ButtonPanel-Service2ToLevel2ColorsButton-Service2Level2ButtonPanel-Service2Level2ContentButton-Service2Level2MarkupPanel.
...
*/
func (group *panelGroup) showService2Level2MarkupPanel(force bool) {
	tools.ShowPanelInButtonGroup(group.service2Level2MarkupPanel, force)
}
