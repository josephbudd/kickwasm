...
func (panelGroup *PanelGroup) defineMembers() (err error) {
	...
	if panelGroup.service4Level4MarkupPanel = notJS.GetElementByID("tabsMasterView-home-pad-Service4Button-Service4Level1ButtonPanel-ColorsButton-Service4Level2ButtonPanel-ColorsButton-Service4Level3ButtonPanel-ColorsButton-Service4Level4ButtonPanel-ContentButton-Service4Level4MarkupPanel"); panelGroup.service4Level4MarkupPanel == null {
		err = errors.New("unable to find #tabsMasterView-home-pad-Service4Button-Service4Level1ButtonPanel-ColorsButton-Service4Level2ButtonPanel-ColorsButton-Service4Level3ButtonPanel-ColorsButton-Service4Level4ButtonPanel-ContentButton-Service4Level4MarkupPanel")
		return
	}
...
// showService4Level4MarkupPanel shows the panel you named Service4Level4MarkupPanel while hiding any other panels in this panel group.
...
*/
func (panelGroup *PanelGroup) showService4Level4MarkupPanel(force bool) {
	panelGroup.tools.ShowPanelInButtonGroup(panelGroup.service4Level4MarkupPanel, force)
}
