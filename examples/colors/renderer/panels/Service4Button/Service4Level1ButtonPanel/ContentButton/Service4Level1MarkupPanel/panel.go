...
func NewPanel(quitCh chan struct{}, tools *viewtools.Tools, notjs *kicknotjs.NotJS, connection map[types.CallID]caller.Renderer) *Panel {
	...
	panel.service4Level1MarkupPanel = notjs.GetElementByID("tabsMasterView-home-pad-Service4Button-Service4Level1ButtonPanel-ContentButton-Service4Level1MarkupPanel")
...
// showService4Level1MarkupPanel shows the panel you named Service4Level1MarkupPanel while hiding any other panels in it's group.
...
//          this panel #tabsMasterView-home-pad-Service4Button-Service4Level1ButtonPanel-ContentButton-Service4Level1MarkupPanel, which you named Service4Level1MarkupPanel, becomes visible.
/* Your note for this panel is:
This is the only content.
Brought to you in the first service color.

*/
func (panel *Panel) showService4Level1MarkupPanel(force bool) {
	panel.tools.ShowPanelInButtonGroup(panel.service4Level1MarkupPanel, force)
}
