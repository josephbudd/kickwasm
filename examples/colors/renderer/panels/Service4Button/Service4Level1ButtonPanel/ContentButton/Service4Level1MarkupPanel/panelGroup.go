...
func (panelGroup *PanelGroup) defineMembers() (err error) {
	...
	if panelGroup.service4Level1MarkupPanel = notJS.GetElementByID("tabsMasterView-home-pad-Service4Button-Service4Level1ButtonPanel-ContentButton-Service4Level1MarkupPanel"); panelGroup.service4Level1MarkupPanel == null {
		err = errors.New("unable to find #tabsMasterView-home-pad-Service4Button-Service4Level1ButtonPanel-ContentButton-Service4Level1MarkupPanel")
		return
	}
...
// This panel's id is tabsMasterView-home-pad-Service4Button-Service4Level1ButtonPanel-ContentButton-Service4Level1MarkupPanel.
...
*/
func (panelGroup *PanelGroup) showService4Level1MarkupPanel(force bool) {
	panelGroup.tools.ShowPanelInButtonGroup(panelGroup.service4Level1MarkupPanel, force)
}
