...
func (group *panelGroup) defineMembers() (err error) {
	...
	if group.service3Level1MarkupPanel = notJS.GetElementByID("tabsMasterView-home-pad-Service3Button-Service3Level1ButtonPanel-Service3Level1ContentButton-Service3Level1MarkupPanel"); group.service3Level1MarkupPanel == null {
		err = errors.New("unable to find #tabsMasterView-home-pad-Service3Button-Service3Level1ButtonPanel-Service3Level1ContentButton-Service3Level1MarkupPanel")
		return
	}
...
// This panel's id is tabsMasterView-home-pad-Service3Button-Service3Level1ButtonPanel-Service3Level1ContentButton-Service3Level1MarkupPanel.
...
*/
func (group *panelGroup) showService3Level1MarkupPanel(force bool) {
	tools.ShowPanelInButtonGroup(group.service3Level1MarkupPanel, force)
}
