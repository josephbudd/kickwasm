...
func (panelGroup *PanelGroup) defineMembers() (err error) {
	...
	if panelGroup.service3Level3MarkupPanel = notJS.GetElementByID("tabsMasterView-home-pad-Service3Button-Service3Level1ButtonPanel-ColorsButton-Service3Level2ButtonPanel-ColorsButton-Service3Level3ButtonPanel-ContentButton-Service3Level3MarkupPanel"); panelGroup.service3Level3MarkupPanel == null {
		err = errors.New("unable to find #tabsMasterView-home-pad-Service3Button-Service3Level1ButtonPanel-ColorsButton-Service3Level2ButtonPanel-ColorsButton-Service3Level3ButtonPanel-ContentButton-Service3Level3MarkupPanel")
		return
	}
...
// showService3Level3MarkupPanel shows the panel you named Service3Level3MarkupPanel while hiding any other panels in this panel group.
...
*/
func (panelGroup *PanelGroup) showService3Level3MarkupPanel(force bool) {
	panelGroup.tools.ShowPanelInButtonGroup(panelGroup.service3Level3MarkupPanel, force)
}
