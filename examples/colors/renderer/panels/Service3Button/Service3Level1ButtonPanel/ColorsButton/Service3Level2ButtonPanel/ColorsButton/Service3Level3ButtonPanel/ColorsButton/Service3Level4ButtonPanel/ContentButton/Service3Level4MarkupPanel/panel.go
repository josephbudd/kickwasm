...
/*
	...
	Panel name: Service3Level4MarkupPanel
	Panel id:   tabsMasterView-home-pad-Service3Button-Service3Level1ButtonPanel-ColorsButton-Service3Level2ButtonPanel-ColorsButton-Service3Level3ButtonPanel-ColorsButton-Service3Level4ButtonPanel-ContentButton-Service3Level4MarkupPanel
...
func NewPanel(quitCh chan struct{}, tools *viewtools.Tools, notjs *kicknotjs.NotJS, connection map[types.CallID]caller.Renderer) *Panel {
	...
	panel.service3Level4MarkupPanel = notjs.GetElementByID("tabsMasterView-home-pad-Service3Button-Service3Level1ButtonPanel-ColorsButton-Service3Level2ButtonPanel-ColorsButton-Service3Level3ButtonPanel-ColorsButton-Service3Level4ButtonPanel-ContentButton-Service3Level4MarkupPanel")
...
// showService3Level4MarkupPanel shows the panel you named Service3Level4MarkupPanel while hiding any other panels in it's group.
...
//          this panel #tabsMasterView-home-pad-Service3Button-Service3Level1ButtonPanel-ColorsButton-Service3Level2ButtonPanel-ColorsButton-Service3Level3ButtonPanel-ColorsButton-Service3Level4ButtonPanel-ContentButton-Service3Level4MarkupPanel, which you named Service3Level4MarkupPanel, becomes visible.
/* Your note for this panel is:
This is the only content.
Brought to you in the first service color.

*/
func (panel *Panel) showService3Level4MarkupPanel(force bool) {
	panel.tools.ShowPanelInButtonGroup(panel.service3Level4MarkupPanel, force)
}
