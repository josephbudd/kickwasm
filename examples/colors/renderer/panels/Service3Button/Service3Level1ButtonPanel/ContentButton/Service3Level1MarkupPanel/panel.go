...
func NewPanel(quitCh chan struct{}, tools *viewtools.Tools, notjs *kicknotjs.NotJS, connection map[types.CallID]caller.Renderer) *Panel {
	...
	panel.service3Level1MarkupPanel = notjs.GetElementByID("tabsMasterView-home-pad-Service3Button-Service3Level1ButtonPanel-ContentButton-Service3Level1MarkupPanel")
...
// showService3Level1MarkupPanel shows the panel you named Service3Level1MarkupPanel while hiding any other panels in it's group.
...
//          this panel #tabsMasterView-home-pad-Service3Button-Service3Level1ButtonPanel-ContentButton-Service3Level1MarkupPanel, which you named Service3Level1MarkupPanel, becomes visible.
/* Your note for this panel is:
This is the only content.
Brought to you in the first service color.

*/
func (panel *Panel) showService3Level1MarkupPanel(force bool) {
	panel.tools.ShowPanelInButtonGroup(panel.service3Level1MarkupPanel, force)
}
