...
echo "     containing all of the files in the /site folder."
echo " * So this process could take a while."
echo " * See func serveFileStore in Serve.go."
echo "cd ${appwd}"
cd ..
echo "kickpack -nu -strict -o=${sitepack_output_package_path} ./site ./Http.yaml"
kickpack -nu -strict -o="${sitepack_output_package_path}" ./site ./Http.yaml
if [ $? -gt 0 ]
then
