...
func (group *panelGroup) defineMembers() (err error) {
 ...
 if panel = document.ElementByID("mainMasterView-home-pad-Action1Button-Action1Level1ButtonPanel-Action1ToLevel2ColorsButton-Action1Level2ButtonPanel-Action1Level2ContentButton-Action1Level2MarkupPanel"); panel == nil {
	err = fmt.Errorf("unable to find #mainMasterView-home-pad-Action1Button-Action1Level1ButtonPanel-Action1ToLevel2ColorsButton-Action1Level2ButtonPanel-Action1Level2ContentButton-Action1Level2MarkupPanel")
		return
    }
    group.action1Level2MarkupPanel = panel.JSValue()
...
// This panel's id is mainMasterView-home-pad-Action1Button-Action1Level1ButtonPanel-Action1ToLevel2ColorsButton-Action1Level2ButtonPanel-Action1Level2ContentButton-Action1Level2MarkupPanel.
...
func (group *panelGroup) showAction1Level2MarkupPanel(force bool) {
	viewtools.ShowPanelInButtonGroup(group.action1Level2MarkupPanel, force)
}
