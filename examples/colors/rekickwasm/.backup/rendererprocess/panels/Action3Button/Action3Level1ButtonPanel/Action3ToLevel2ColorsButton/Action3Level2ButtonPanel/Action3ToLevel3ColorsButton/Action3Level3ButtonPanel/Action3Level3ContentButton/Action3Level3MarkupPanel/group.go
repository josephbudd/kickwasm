...
func (group *panelGroup) defineMembers() (err error) {
 ...
 if panel = document.ElementByID("mainMasterView-home-pad-Action3Button-Action3Level1ButtonPanel-Action3ToLevel2ColorsButton-Action3Level2ButtonPanel-Action3ToLevel3ColorsButton-Action3Level3ButtonPanel-Action3Level3ContentButton-Action3Level3MarkupPanel"); panel == nil {
	err = fmt.Errorf("unable to find #mainMasterView-home-pad-Action3Button-Action3Level1ButtonPanel-Action3ToLevel2ColorsButton-Action3Level2ButtonPanel-Action3ToLevel3ColorsButton-Action3Level3ButtonPanel-Action3Level3ContentButton-Action3Level3MarkupPanel")
		return
    }
    group.action3Level3MarkupPanel = panel.JSValue()
...
// This panel's id is mainMasterView-home-pad-Action3Button-Action3Level1ButtonPanel-Action3ToLevel2ColorsButton-Action3Level2ButtonPanel-Action3ToLevel3ColorsButton-Action3Level3ButtonPanel-Action3Level3ContentButton-Action3Level3MarkupPanel.
...
func (group *panelGroup) showAction3Level3MarkupPanel(force bool) {
	viewtools.ShowPanelInButtonGroup(group.action3Level3MarkupPanel, force)
}
