...
type panelGroup struct {
	action3Level4MarkupPanel js.Value
}
...
// showAction3Level4MarkupPanel shows the panel you named Action3Level4MarkupPanel while hiding any other panels in this panel group.
// This panel's id is mainMasterView-home-pad-Action3Button-Action3Level1ButtonPanel-Action3ToLevel2ColorsButton-Action3Level2ButtonPanel-Action3ToLevel3ColorsButton-Action3Level3ButtonPanel-Action3ToLevel4ColorsButton-Action3Level4ButtonPanel-Action3Level4ContentButton-Action3Level4MarkupPanel.
...
*/
func (group *panelGroup) showAction3Level4MarkupPanel(force bool) {
	viewtools.ShowPanelInButtonGroup(group.action3Level4MarkupPanel, force)
}
