...
func (group *panelGroup) defineMembers() (err error) {
 ...
 if panel = document.ElementByID("mainMasterView-home-pad-Action5Button-Action5Level1ButtonPanel-Action5ToLevel2ColorsButton-Action5Level2ButtonPanel-Action5ToLevel3ColorsButton-Action5Level3ButtonPanel-Action5Level3ContentButton-Action5Level3MarkupPanel"); panel == nil {
	err = fmt.Errorf("unable to find #mainMasterView-home-pad-Action5Button-Action5Level1ButtonPanel-Action5ToLevel2ColorsButton-Action5Level2ButtonPanel-Action5ToLevel3ColorsButton-Action5Level3ButtonPanel-Action5Level3ContentButton-Action5Level3MarkupPanel")
		return
    }
    group.action5Level3MarkupPanel = panel.JSValue()
...
// This panel's id is mainMasterView-home-pad-Action5Button-Action5Level1ButtonPanel-Action5ToLevel2ColorsButton-Action5Level2ButtonPanel-Action5ToLevel3ColorsButton-Action5Level3ButtonPanel-Action5Level3ContentButton-Action5Level3MarkupPanel.
...
func (group *panelGroup) showAction5Level3MarkupPanel(force bool) {
	viewtools.ShowPanelInButtonGroup(group.action5Level3MarkupPanel, force)
}
