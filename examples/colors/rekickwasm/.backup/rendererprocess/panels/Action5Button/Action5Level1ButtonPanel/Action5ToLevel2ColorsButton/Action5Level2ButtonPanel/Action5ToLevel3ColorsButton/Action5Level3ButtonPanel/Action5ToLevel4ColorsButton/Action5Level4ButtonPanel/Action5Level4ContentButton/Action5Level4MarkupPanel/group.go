...
type panelGroup struct {
	action5Level4MarkupPanel js.Value
}
...
// showAction5Level4MarkupPanel shows the panel you named Action5Level4MarkupPanel while hiding any other panels in this panel group.
// This panel's id is mainMasterView-home-pad-Action5Button-Action5Level1ButtonPanel-Action5ToLevel2ColorsButton-Action5Level2ButtonPanel-Action5ToLevel3ColorsButton-Action5Level3ButtonPanel-Action5ToLevel4ColorsButton-Action5Level4ButtonPanel-Action5Level4ContentButton-Action5Level4MarkupPanel.
...
*/
func (group *panelGroup) showAction5Level4MarkupPanel(force bool) {
	viewtools.ShowPanelInButtonGroup(group.action5Level4MarkupPanel, force)
}
