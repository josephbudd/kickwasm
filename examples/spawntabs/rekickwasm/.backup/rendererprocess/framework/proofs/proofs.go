...
var (
	homeNames = []string{"TabsButton"}

	buttonNamePanelNames = map[string][]string{"TabsButton":[]string{"TabsButtonTabBarPanel"}}

	tabNamePanelNames = map[string][]string{"FirstTab":[]string{"CreatePanel"}, "SecondTab":[]string{"HelloWorldTemplatePanel"}}

	panelNameButtonNames = map[string][]string{}

	panelNameTabNames = map[string][]string{"TabsButtonTabBarPanel":[]string{"FirstTab", "SecondTab"}}
)
