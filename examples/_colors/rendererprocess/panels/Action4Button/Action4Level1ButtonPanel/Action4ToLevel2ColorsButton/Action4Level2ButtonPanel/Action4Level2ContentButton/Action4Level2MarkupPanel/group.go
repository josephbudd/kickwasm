...
type panelGroup struct {
	action4Level2MarkupPanel js.Value
}
...
func (group *panelGroup) defineMembers() (err error) {
 ...
 if panel = document.ElementByID("mainMasterView-home-pad-Action4Button-Action4Level1ButtonPanel-Action4ToLevel2ColorsButton-Action4Level2ButtonPanel-Action4Level2ContentButton-Action4Level2MarkupPanel"); panel == nil {
	err = fmt.Errorf("unable to find #mainMasterView-home-pad-Action4Button-Action4Level1ButtonPanel-Action4ToLevel2ColorsButton-Action4Level2ButtonPanel-Action4Level2ContentButton-Action4Level2MarkupPanel")
		return
    }
