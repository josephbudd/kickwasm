...
func (group *panelGroup) defineMembers() (err error) {
 ...
 if panel = document.ElementByID("mainMasterView-home-pad-Action5Button-Action5Level1ButtonPanel-Action5ToLevel2ColorsButton-Action5Level2ButtonPanel-Action5Level2ContentButton-Action5Level2MarkupPanel"); panel == nil {
	err = fmt.Errorf("unable to find #mainMasterView-home-pad-Action5Button-Action5Level1ButtonPanel-Action5ToLevel2ColorsButton-Action5Level2ButtonPanel-Action5Level2ContentButton-Action5Level2MarkupPanel")
		return
    }
    group.action5Level2MarkupPanel = panel.JSValue()
...
// This panel's id is mainMasterView-home-pad-Action5Button-Action5Level1ButtonPanel-Action5ToLevel2ColorsButton-Action5Level2ButtonPanel-Action5Level2ContentButton-Action5Level2MarkupPanel.
...
func (group *panelGroup) showAction5Level2MarkupPanel(force bool) {
	viewtools.ShowPanelInButtonGroup(group.action5Level2MarkupPanel, force)
}
