...
var homeEmptyInsidePanelNamePathMap = map[string]map[string][]string{"TabsButton": map[string][]string{"CreatePanel": []string{"TabsButton", "TabsButtonTabBarPanel", "FirstTab"}}}
...
func serveMainHTML(w http.ResponseWriter) {
	...
	if bb, found = spawnwidgetssitepack.Contents(tpath); !found {
