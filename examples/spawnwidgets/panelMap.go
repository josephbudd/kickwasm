...
var serviceEmptyInsidePanelNamePathMap = map[string]map[string][]string{"Tabs": map[string][]string{"CreatePanel": []string{"TabsButton", "TabsButtonTabBarPanel", "FirstTab"}}}
