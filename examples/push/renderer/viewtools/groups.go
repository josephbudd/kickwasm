...
func (tools *Tools) initializeGroups() {
	...
	var buttonid string
	var panel js.Value
	// PushTime PushButton button.
	buttonid = "tabsMasterView-home-pad-PushButton"
	tools.buttonPanelsMap[buttonid] = make([]js.Value, 0, 5)
	panel = tools.NotJS.GetElementByID("tabsMasterView-home-pad-PushButton-PushPanel")
	if panel == js.Undefined() {
		message := "viewtools.initializeGroups: Cant find #tabsMasterView-home-pad-PushButton-PushPanel"
