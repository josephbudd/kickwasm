...
// The first lists act as a series of filters followed by a final filtered list of records.
type FVList struct {
	div     js.Value
	IDState uint64
	panels  []*FVListPanel
...
//  div must have.
//   * a styled height ( See "kickwasmwidgets/css/vlist.css" )
// Param IDState
//  is vlist vlist's unique id.
//  It must be generated by VListState.GetNextState().
//  It will be passed as param state being ored with
//  * StateInitialize in calls to needToInitializeFunc.
//  * StatePrepend in calls to needToPrependFunc.
//  * StateAppend in calls to needToAppendFunc.
//  * The index of one of this fvlist's subvlists.
// Param onSizeFunc
//  is called when there will be a size to the list.
// Param onNoSizeFunc
//  is called when there will be no size to the list.
// Param hideFunc is a func that will hide a div.
//  It will take one param, the js.Value of a div.
// Param showFunc is a func that will show a div.
//  It will take one param, the js.Value of a div.
// Param isShownFunc is a func that will return if a div is shown.
//  It will take one param, the js.Value of a div.
