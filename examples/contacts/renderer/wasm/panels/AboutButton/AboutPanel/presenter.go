...
func (presenter *Presenter) displayReleases(thisVersion string, releases map[string]map[string][]string) {
	...
	div := notjs.GetElementByID("tabsMasterView_home_pad_AutoGeneratedAboutButton_AutoGeneratedAboutPanel_tab_bar-ReleasesTabPanel-inner-AutoGeneratedReleasesPanel")
...
func (presenter *Presenter) displayContributors(contributors map[string]string) {
	notjs := presenter.notjs
	div := notjs.GetElementByID("tabsMasterView_home_pad_AutoGeneratedAboutButton_AutoGeneratedAboutPanel_tab_bar-ContributorsTabPanel-inner-AutoGeneratedContributorsPanel")
...
func (presenter *Presenter) displayCredits(credits []about.Credit) {
	...
	*/
	notjs := presenter.notjs
	div := notjs.GetElementByID("tabsMasterView_home_pad_AutoGeneratedAboutButton_AutoGeneratedAboutPanel_tab_bar-CreditsTabPanel-inner-AutoGeneratedCreditsPanel")
...
func (presenter *Presenter) displayLicenses(licenses []about.License) {
	...
	*/
	notjs := presenter.notjs
	inner := notjs.GetElementByID("tabsMasterView_home_pad_AutoGeneratedAboutButton_AutoGeneratedAboutPanel_tab_bar-LicensesTabPanel-inner-AutoGeneratedLicensesPanel")
