...
func (tools *Tools) initializeTabBar() {
	...
	tools.tabberLastPanelLevels["tabsMasterView_home_pad_AutoGeneratedAboutButton_AutoGeneratedAboutPanel_tab_bar"] = "tabsMasterView_home_pad_AutoGeneratedAboutButton_AutoGeneratedAboutPanel_tab_bar-ReleasesTabPanel"
