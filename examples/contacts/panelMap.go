...
var serviceEmptyInsidePanelNamePathMap = map[string]map[string][]string{"RemoveAContact": map[string][]string{"RemoveContactSelectPanel": []string{"RemoveButton"}, "RemoveContactConfirmPanel": []string{"RemoveButton"}, "RemoveContactNotReadyPanel": []string{"RemoveButton"}}, "About": map[string][]string{"CreditTabPanel": []string{"AboutButton", "AboutTabBarPanel", "CreditTab"}, "RecordsTabPanel": []string{"AboutButton", "AboutTabBarPanel", "RecordsTab"}, "LiscenseTabPanel": []string{"AboutButton", "AboutTabBarPanel", "LiscenseTab"}}, "AddAContact": map[string][]string{"AddContactPanel": []string{"AddButton"}}, "EditAContact": map[string][]string{"EditContactNotReadyPanel": []string{"EditButton"}, "EditContactSelectPanel": []string{"EditButton"}, "EditContactEditPanel": []string{"EditButton"}}}
