...
#{{.IDSliderCollection}} > .{{.SliderPanel}} > div.{{.PanelHeading}} > h2.{{.ClassCookieCrumbLevelPrefix}}1,
#{{.IDSliderCollection}} > .{{.SliderPanel}} > div.{{.PanelHeading}} > h2.{{.ClassCookieCrumbLevelPrefix}}2,
#{{.IDSliderCollection}} > .{{.SliderPanel}} > div.{{.PanelHeading}} > h2.{{.ClassCookieCrumbLevelPrefix}}3,
#{{.IDSliderCollection}} > .{{.SliderPanel}} > div.{{.PanelHeading}} > h2.{{.ClassCookieCrumbLevelPrefix}}4,
#{{.IDSliderCollection}} > .{{.SliderPanel}} > div.{{.PanelHeading}} > h2.{{.ClassCookieCrumbLevelPrefix}}5
{
  /* margin-top:0;
  margin-bottom:5px; */
  font-size:24px;
