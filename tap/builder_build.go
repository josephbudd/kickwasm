...
// AboutMapPointers is pointers to important about panels and tabs.
type AboutMapPointers struct {
...
// AboutIDs is the ids needed for javascript.
type AboutIDs struct {
	ButtonName                  string
	ButtonID                    string
...
// AddAbout add the about button and sub tabs.
func (builder *Builder) AddAbout() {
	aboutMap := &AboutMapPointers{}
	builder.aboutMapPointers = aboutMap
	// service
	service := &Service{
		Name:      "About",
		Generated: true,
	}
	aboutMap.AboutService = service
	builder.Services = append(builder.Services, service)
	// about service button
	aboutButton := &Button{
		ID:        "AutoGeneratedAboutButton",
		Label:     "About",
	...
	aboutMap.AboutButton = aboutButton
	service.Button = aboutButton
	// button's only panel
	p := newPanel()
	aboutButton.Panels = append(aboutButton.Panels, p)
	aboutMap.DefaultPanel = p
	p.Generated = true
	p.ID = "AutoGeneratedAboutPanel"
	p.Name = "AutoGeneratedAboutPanel"
	p.Note = "This panel is the Auto Generated About tab bar."
	// tab bar
	t := &Tab{
		ID:        "ReleasesTab",
		Label:     "Releases",
	...
	tp := newPanel()
	tp.Generated = true
	tp.ID = "AutoGeneratedReleasesPanel"
	tp.Name = "AutoGeneratedReleasesPanel"
	tp.Note = "Auto Generated About | Releases tab."
	t.Panels = append(t.Panels, tp)
	p.Tabs = append(p.Tabs, t)
	aboutMap.ReleasesTab = t
	t = &Tab{
		ID:        "ContributorsTab",
		Label:     "Contributors",
		Generated: true,
	...
	tp = newPanel()
	tp.Generated = true
	tp.ID = "AutoGeneratedContributorsPanel"
	tp.Name = "AutoGeneratedContributorsPanel"
	tp.Note = "Auto Generated About | Contributors tab."
	t.Panels = append(t.Panels, tp)
	p.Tabs = append(p.Tabs, t)
	aboutMap.ContributorsTab = t
	t = &Tab{
		ID:        "CreditsTab",
		Label:     "Credits",
		Generated: true,
	...
	tp = newPanel()
	tp.Generated = true
	tp.ID = "AutoGeneratedCreditsPanel"
	tp.Name = "AutoGeneratedCreditsPanel"
	tp.Note = "Auto Generated About | Credits tab."
	t.Panels = append(t.Panels, tp)
	p.Tabs = append(p.Tabs, t)
	aboutMap.CreditsTab = t
	t = &Tab{
		ID:        "LicensesTab",
		Label:     "Licenses",
		Generated: true,
	...
	tp = newPanel()
	tp.Generated = true
	tp.ID = "AutoGeneratedLicensesPanel"
	tp.Name = "AutoGeneratedLicensesPanel"
	tp.Note = "Auto Generated About | Licenses tab."
	t.Panels = append(t.Panels, tp)
	p.Tabs = append(p.Tabs, t)
	aboutMap.LicensesTab = t
}
