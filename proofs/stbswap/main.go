...
// Swap spawn tabs between 2 panels.
// DO NOT EVER MOVE ProveButtonPanel OUT OF ProveButton

const (
	kickwasmDotYAML = `title: Swap spawn tabs between 2 panels.
...
- name: ProveButton
  ...
  - name: ProveButtonPanel
    ...
    markup: |
      <p>Prove It!</p>
`
	rekickwasmDotYAML = `title: Swap spawn tabs between 2 panels.
importPath: github.com/josephbudd/kickwasm/proofs/%[1]s/%[1]stest
buttons:
- name: FirstButton
  label: 1
...
func main() {
	...
	err = fix.Refactor(appName, "Swap spawn tabs between 2 panels.", sourceCodeFolderPath, kickwasmDotYAML, rekickwasmDotYAML, proveDotGo, false, testing)
	if err != nil {
