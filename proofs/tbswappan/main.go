...
// Swap panels between 2 tabs.
// DO NOT EVER MOVE ProveButtonPanel OUT OF ProveButton

const (
	kickwasmDotYAML = `title: Swap panels between 2 tabs.
...
- name: ProveButton
  ...
  - name: ProveButtonPanel
    ...
    markup: |
      <p>Prove It!</p>
`
	rekickwasmDotYAML = `title: Swap panels between 2 tabs.
importPath: github.com/josephbudd/kickwasm/proofs/%[1]s/%[1]stest
buttons:
- name: FirstButton
  label: 1
...
func main() {
	...
	err = fix.Refactor(appName, "Swap panels between 2 tabs.", sourceCodeFolderPath, kickwasmDotYAML, rekickwasmDotYAML, proveDotGo, false, testing)
	if err != nil {
