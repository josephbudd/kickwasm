...
// Rotate a tab and a spawn tab in a panel.
// DO NOT EVER MOVE ProveButtonPanel OUT OF ProveButton

const (
	kickwasmDotYAML = `title: Rotate a tab and a spawn tab in a panel.
...
- name: ProveButton
  ...
  - name: ProveButtonPanel
    ...
    markup: |
      <p>Prove It!</p>
`
	rekickwasmDotYAML = `title: Rotate a tab and a spawn tab in a panel.
importPath: github.com/josephbudd/kickwasm/proofs/%[1]s/%[1]stest
buttons:
- name: FirstButton
  label: 1
...
func main() {
	...
	err = fix.Refactor(appName, "Rotate a tab and a spawn tab in a panel.", sourceCodeFolderPath, kickwasmDotYAML, rekickwasmDotYAML, proveDotGo, false, testing)
	if err != nil {
