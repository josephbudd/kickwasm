...
func initializeGroups() {
	...
	var buttonid string
	var panel js.Value
	// ProveButton ProveButton button.
	buttonid = "mainMasterView-home-pad-ProveButton"
	buttonPanelsMap[buttonid] = make([]js.Value, 0, 5)
	panel = getElementByID(document, "mainMasterView-home-pad-ProveButton-ProveButtonPanel")
	if panel.IsUndefined() {
		message := "viewtools.initializeGroups: Cant find #mainMasterView-home-pad-ProveButton-ProveButtonPanel"
		alert.Invoke(message)
		return
	}
	buttonPanelsMap[buttonid] = append(buttonPanelsMap[buttonid], panel)
	// SchoolButton SchoolButton button.
	buttonid = "mainMasterView-home-pad-SchoolButton"
	buttonPanelsMap[buttonid] = make([]js.Value, 0, 5)
	panel = getElementByID(document, "mainMasterView-home-pad-SchoolButton-SchoolCourseNotReadyPanel")
	if panel.IsUndefined() {
		message := "viewtools.initializeGroups: Cant find #mainMasterView-home-pad-SchoolButton-SchoolCourseNotReadyPanel"
		alert.Invoke(message)
		return
	}
	buttonPanelsMap[buttonid] = append(buttonPanelsMap[buttonid], panel)
	panel = getElementByID(document, "mainMasterView-home-pad-SchoolButton-SchoolPanel")
	if panel.IsUndefined() {
		message := "viewtools.initializeGroups: Cant find #mainMasterView-home-pad-SchoolButton-SchoolPanel"
		alert.Invoke(message)
		return
	}
	buttonPanelsMap[buttonid] = append(buttonPanelsMap[buttonid], panel)
	// SchoolButton SchoolCourseTab button.
	buttonid = "mainMasterView_home_pad_SchoolButton_SchoolPanel_tab_bar-SchoolCourseTab"
	buttonPanelsMap[buttonid] = make([]js.Value, 0, 5)
	panel = getElementByID(document, "mainMasterView_home_pad_SchoolButton_SchoolPanel_tab_bar-SchoolCourseTabPanel-inner-SchoolCourseSelectPanel")
	if panel.IsUndefined() {
		message := "viewtools.initializeGroups: Cant find #mainMasterView_home_pad_SchoolButton_SchoolPanel_tab_bar-SchoolCourseTabPanel-inner-SchoolCourseSelectPanel"
		alert.Invoke(message)
		return
	}
	buttonPanelsMap[buttonid] = append(buttonPanelsMap[buttonid], panel)
	panel = getElementByID(document, "mainMasterView_home_pad_SchoolButton_SchoolPanel_tab_bar-SchoolCourseTabPanel-inner-SchoolCourseStatsPanel")
	if panel.IsUndefined() {
		message := "viewtools.initializeGroups: Cant find #mainMasterView_home_pad_SchoolButton_SchoolPanel_tab_bar-SchoolCourseTabPanel-inner-SchoolCourseStatsPanel"
		alert.Invoke(message)
		return
	}
	buttonPanelsMap[buttonid] = append(buttonPanelsMap[buttonid], panel)
	// SchoolButton SchoolCourseCopyTab button.
	buttonid = "mainMasterView_home_pad_SchoolButton_SchoolPanel_tab_bar-SchoolCourseCopyTab"
	buttonPanelsMap[buttonid] = make([]js.Value, 0, 5)
	panel = getElementByID(document, "mainMasterView_home_pad_SchoolButton_SchoolPanel_tab_bar-SchoolCourseCopyTabPanel-inner-SchoolCourseCopyChoosePanel")
	if panel.IsUndefined() {
		message := "viewtools.initializeGroups: Cant find #mainMasterView_home_pad_SchoolButton_SchoolPanel_tab_bar-SchoolCourseCopyTabPanel-inner-SchoolCourseCopyChoosePanel"
		alert.Invoke(message)
		return
	}
	buttonPanelsMap[buttonid] = append(buttonPanelsMap[buttonid], panel)
	panel = getElementByID(document, "mainMasterView_home_pad_SchoolButton_SchoolPanel_tab_bar-SchoolCourseCopyTabPanel-inner-SchoolCourseCopyCompletedPanel")
	if panel.IsUndefined() {
		message := "viewtools.initializeGroups: Cant find #mainMasterView_home_pad_SchoolButton_SchoolPanel_tab_bar-SchoolCourseCopyTabPanel-inner-SchoolCourseCopyCompletedPanel"
		alert.Invoke(message)
		return
	}
	buttonPanelsMap[buttonid] = append(buttonPanelsMap[buttonid], panel)
	panel = getElementByID(document, "mainMasterView_home_pad_SchoolButton_SchoolPanel_tab_bar-SchoolCourseCopyTabPanel-inner-SchoolCourseCopyPracticePanel")
	if panel.IsUndefined() {
		message := "viewtools.initializeGroups: Cant find #mainMasterView_home_pad_SchoolButton_SchoolPanel_tab_bar-SchoolCourseCopyTabPanel-inner-SchoolCourseCopyPracticePanel"
		alert.Invoke(message)
		return
	}
	buttonPanelsMap[buttonid] = append(buttonPanelsMap[buttonid], panel)
	panel = getElementByID(document, "mainMasterView_home_pad_SchoolButton_SchoolPanel_tab_bar-SchoolCourseCopyTabPanel-inner-SchoolCourseCopyTestPanel")
	if panel.IsUndefined() {
		message := "viewtools.initializeGroups: Cant find #mainMasterView_home_pad_SchoolButton_SchoolPanel_tab_bar-SchoolCourseCopyTabPanel-inner-SchoolCourseCopyTestPanel"
		alert.Invoke(message)
		return
	}
	buttonPanelsMap[buttonid] = append(buttonPanelsMap[buttonid], panel)
	// SchoolButton SchoolCourseKeyTab button.
	buttonid = "mainMasterView_home_pad_SchoolButton_SchoolPanel_tab_bar-SchoolCourseKeyTab"
	buttonPanelsMap[buttonid] = make([]js.Value, 0, 5)
	panel = getElementByID(document, "mainMasterView_home_pad_SchoolButton_SchoolPanel_tab_bar-SchoolCourseKeyTabPanel-inner-SchoolCourseKeyChoosePanel")
	if panel.IsUndefined() {
		message := "viewtools.initializeGroups: Cant find #mainMasterView_home_pad_SchoolButton_SchoolPanel_tab_bar-SchoolCourseKeyTabPanel-inner-SchoolCourseKeyChoosePanel"
		alert.Invoke(message)
		return
	}
	buttonPanelsMap[buttonid] = append(buttonPanelsMap[buttonid], panel)
	panel = getElementByID(document, "mainMasterView_home_pad_SchoolButton_SchoolPanel_tab_bar-SchoolCourseKeyTabPanel-inner-SchoolCourseKeyCompletedPanel")
	if panel.IsUndefined() {
		message := "viewtools.initializeGroups: Cant find #mainMasterView_home_pad_SchoolButton_SchoolPanel_tab_bar-SchoolCourseKeyTabPanel-inner-SchoolCourseKeyCompletedPanel"
		alert.Invoke(message)
		return
	}
	buttonPanelsMap[buttonid] = append(buttonPanelsMap[buttonid], panel)
	panel = getElementByID(document, "mainMasterView_home_pad_SchoolButton_SchoolPanel_tab_bar-SchoolCourseKeyTabPanel-inner-SchoolCourseKeyPracticePanel")
	if panel.IsUndefined() {
		message := "viewtools.initializeGroups: Cant find #mainMasterView_home_pad_SchoolButton_SchoolPanel_tab_bar-SchoolCourseKeyTabPanel-inner-SchoolCourseKeyPracticePanel"
		alert.Invoke(message)
		return
	}
	buttonPanelsMap[buttonid] = append(buttonPanelsMap[buttonid], panel)
	panel = getElementByID(document, "mainMasterView_home_pad_SchoolButton_SchoolPanel_tab_bar-SchoolCourseKeyTabPanel-inner-SchoolCourseKeyTestPanel")
	if panel.IsUndefined() {
		message := "viewtools.initializeGroups: Cant find #mainMasterView_home_pad_SchoolButton_SchoolPanel_tab_bar-SchoolCourseKeyTabPanel-inner-SchoolCourseKeyTestPanel"
		alert.Invoke(message)
		return
	}
	buttonPanelsMap[buttonid] = append(buttonPanelsMap[buttonid], panel)
