...
var (
	homeNames = []string{"SchoolButton", "ProveButton"}

	buttonNamePanelNames = map[string][]string{"ProveButton":[]string{"ProveButtonPanel"}, "SchoolButton":[]string{"SchoolCourseNotReadyPanel", "SchoolPanel"}}

	tabNamePanelNames = map[string][]string{"SchoolCourseCopyTab":[]string{"SchoolCourseCopyCompletedPanel", "SchoolCourseCopyChoosePanel", "SchoolCourseCopyPracticePanel", "SchoolCourseCopyTestPanel"}, "SchoolCourseKeyTab":[]string{"SchoolCourseKeyCompletedPanel", "SchoolCourseKeyChoosePanel", "SchoolCourseKeyPracticePanel", "SchoolCourseKeyTestPanel"}, "SchoolCourseTab":[]string{"SchoolCourseSelectPanel", "SchoolCourseStatsPanel"}}

	panelNameButtonNames = map[string][]string{}

	panelNameTabNames = map[string][]string{"SchoolPanel":[]string{"SchoolCourseTab", "SchoolCourseCopyTab", "SchoolCourseKeyTab"}}
)
