...
var homeEmptyInsidePanelNamePathMap = map[string]map[string][]string{"ProveButton": map[string][]string{"ProveButtonPanel": []string{"ProveButton"}}, "SchoolButton": map[string][]string{"SchoolCourseCopyChoosePanel": []string{"SchoolButton", "SchoolPanel", "SchoolCourseCopyTab"}, "SchoolCourseCopyCompletedPanel": []string{"SchoolButton", "SchoolPanel", "SchoolCourseCopyTab"}, "SchoolCourseCopyPracticePanel": []string{"SchoolButton", "SchoolPanel", "SchoolCourseCopyTab"}, "SchoolCourseCopyTestPanel": []string{"SchoolButton", "SchoolPanel", "SchoolCourseCopyTab"}, "SchoolCourseKeyChoosePanel": []string{"SchoolButton", "SchoolPanel", "SchoolCourseKeyTab"}, "SchoolCourseKeyCompletedPanel": []string{"SchoolButton", "SchoolPanel", "SchoolCourseKeyTab"}, "SchoolCourseKeyPracticePanel": []string{"SchoolButton", "SchoolPanel", "SchoolCourseKeyTab"}, "SchoolCourseKeyTestPanel": []string{"SchoolButton", "SchoolPanel", "SchoolCourseKeyTab"}, "SchoolCourseNotReadyPanel": []string{"SchoolButton"}, "SchoolCourseSelectPanel": []string{"SchoolButton", "SchoolPanel", "SchoolCourseTab"}, "SchoolCourseStatsPanel": []string{"SchoolButton", "SchoolPanel", "SchoolCourseTab"}}}
...
func serveMainHTML(w http.ResponseWriter) {
	...
	if bb, found = tp2btestsitepack.Contents(tpath); !found {
